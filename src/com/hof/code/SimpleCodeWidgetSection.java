...
public class SimpleCodeWidgetSection extends ParameterSection {
    ...
    public List<Parameter> getParameters() {
        ...
        p.setName("Message"); //Name that will be displayed to the user when they are editing this.
        p.setProperty("message"); //Property that this will be stored as in the database, and the name of the property to access when using getFormatValue
        ...
        p.addViewOption("width", "240px"); //Set the display width of the textbox to 240px
        parameterList.add(p);
